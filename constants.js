...
'Splash-bro': {
title: 'Specialista da 3',
contents: "Lo Splash-Bro è un giocatore di pallacanestro che ama tirare da tre punti. Non si accontenta di segnare solo due punti, ma vuole sempre di più e cerca di allungare la distanza dalla linea del tiro libero. La sua forza è la precisione nel gesto, che fa di lui un tiro libero letale per gli avversari. Il suo spirito allegro e spensierato lo rende divertente da guardare, come se stesse giocando a basket solo per divertimento. Quando segna, le sue esultanze sono sempre colorate e coinvolgenti, stimolando ancor di più la squadra. Il suo fallo corto non è mai pregiudizio nei confronti della squadra, ma è bensì un metodo per incoraggiare gli altri compagni a non perdere la concentrazione sulla partita. Il giovane Splash-Bro è un giocatore entusiasmante, che ha conquistato la simpatia del pubblico, la stima dei compagni, l'ammirazione degli allenatori e lo rispetto degli avversari.",
},
'happy': {
